...
int main(int argc, char * argv[])
{
    ...
    // PathSimplification::DistanceThreshold(input, output, 10);
    // PathSimplification::AngleThreshold(input, output, 20);
    // PathSimplification::DouglasPeucker(input, output, 10);
